...
;;  Based on the 'Terrain Builder - elevation' template by Andreas Angourakis (andros.spica@gmail.com)
;;  This model template is a cleaner version of the Terrain Generator model v.1, using local scale (https://github.com/Andros-Spica/ProceduralMap-NetLogo)
;;
...
to export-terrain
  ...
  let filePath (word "terrains//terrainBuilder_elevation_" type-of-experiment "_w=" world-width "_h=" world-height "_a=" algorithm-style "_seed=" randomSeed)
...
to import-terrain
  ...
  let filePath (word "terrains//terrainGenerator_v2_" type-of-experiment "_w=" world-width "_h=" world-height "_a=" algorithm-style "_seed=" randomSeed)
